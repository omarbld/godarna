...
class _BookingsScreenState extends State<BookingsScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(AppStrings.getString('bookings', context)),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          // Navigate to property search to create new booking
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (_) => const Scaffold(
                body: Center(
                  child: Text('اختر عقاراً لإنشاء حجز جديد'),
                ),
              ),
            ),
          );
              ...
              children: [
                ClipRRect(
                  ...
                  child: Container(
                    ...
                    child: const Icon(Icons.home, color: AppColors.textLight),
                  ),
                ),
